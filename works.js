document.addEventListener("DOMContentLoaded", () => {
    ...
    const detailPageGalleries = {
        "ecommerce-detail": [
            ...
            {
                title: "반려동물 유모차 상세페이지",
                description: "반려동물 유모차의 디자인, 사용 장면, 주요 기능과 제품 정보를 순서대로 구성한 상세페이지 디자인입니다.",
                images: [
                ...
                alts: [
                    "반려동물 유모차 상세페이지 메인 비주얼",
                    "반려동물 유모차 해외 평점과 주요 특징 소개",
                    "반려동물 유모차 사용자 리뷰",
                    "반려동물과 함께하는 외출 장면",
                    "반려동물 유모차 주요 기능 소개",
                    "서스펜션과 바퀴 주행 애니메이션",
                    "폴딩과 분리형 바구니 사용 애니메이션",
                    "안전 고리와 메쉬창 출입구 애니메이션",
                    "반려동물 유모차 외관과 기능 소개",
                    "원터치 폴딩과 출입구 기능 소개",
                    "탑승 무게와 안전 사용 가이드",
                    "반려동물 유모차 색상별 구성품 안내",
