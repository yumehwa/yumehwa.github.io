document.addEventListener("DOMContentLoaded", () => {
    ...
    const detailPageGalleries = {
        "ecommerce-detail": [
            ...
            {
                title: "Pet Stroller Product Detail Page",
                description: "A product detail page presenting a pet stroller's design, use cases, key features, configuration, and product information in sequence.",
                images: [
                    "images/works/detail-pages/pet-stroller/pet-stroller-001.jpg",
                    "images/works/detail-pages/pet-stroller/pet-stroller-002.jpg",
                    "images/works/detail-pages/pet-stroller/pet-stroller-003.jpg",
                    "images/works/detail-pages/pet-stroller/pet-stroller-004.jpg",
                    "images/works/detail-pages/pet-stroller/pet-stroller-005.jpg",
                    "images/works/detail-pages/pet-stroller/pet-stroller-006.webp",
                    "images/works/detail-pages/pet-stroller/pet-stroller-007.webp",
                    "images/works/detail-pages/pet-stroller/pet-stroller-008.webp",
                    "images/works/detail-pages/pet-stroller/pet-stroller-009.jpg",
                    "images/works/detail-pages/pet-stroller/pet-stroller-010.jpg",
                    "images/works/detail-pages/pet-stroller/pet-stroller-011.jpg",
                    "images/works/detail-pages/pet-stroller/pet-stroller-012.jpg",
                    "images/works/detail-pages/pet-stroller/pet-stroller-013.jpg",
                    "images/works/detail-pages/pet-stroller/pet-stroller-014.jpg",
                ],
                alts: [
                    "Pet stroller product detail page hero visual",
                    "Pet stroller ratings and key features",
                    "Pet stroller customer reviews",
                    "Outdoor scene with a pet stroller",
                    "Pet stroller key features",
                    "Pet stroller suspension and wheel animation",
                    "Pet stroller folding and detachable basket animation",
                    "Pet stroller safety leash and mesh entrance animation",
                    "Pet stroller exterior and features",
                    "Pet stroller one-touch folding and entrance features",
                    "Pet stroller weight and safety guide",
                    "Pet stroller color options and included components",
                    "Pet stroller product specifications",
                    "Pet stroller returns and purchase information",
                ],
            },
            {
